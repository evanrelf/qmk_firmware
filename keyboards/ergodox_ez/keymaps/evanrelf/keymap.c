...
[BASE] = LAYOUT_ergodox_pretty(
  KC_GRAVE              , KC_1                  , KC_2                  , KC_3                  , KC_4                  , KC_5                  , DF(BASE_CDH)          , /**/ XXXXXXX               , KC_6                  , KC_7                  , KC_8                  , KC_9                  , KC_0                  , XXXXXXX               ,
...
/* Keymap 2: Base (Colemak DH)
 *
 * ,--------------------------------------------------.           ,--------------------------------------------------.
 * |   `    |   1  |   2  |   3  |   4  |   5  |QWERTY|           |      |   6  |   7  |   8  |   9  |   0  |        |
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
 ...
 *                                 ,------|------|------|       |------+------+------.
 *                                 |      |      |      |       |      |      |      |
 *                                 |Music |Layer3|------|       |------|Layer3| Enter|
 *                                 |      |      |      |       |      |      |      |
 *                                 `--------------------'       `--------------------'
 */
[BASE_CDH] = LAYOUT_ergodox_pretty(
  KC_GRAVE              , KC_1                  , KC_2                  , KC_3                  , KC_4                  , KC_5                  , DF(BASE)              , /**/ XXXXXXX               , KC_6                  , KC_7                  , KC_8                  , KC_9                  , KC_0                  , XXXXXXX               ,
  KC_TAB                , KC_Q                  , KC_W                  , KC_F                  , KC_P                  , KC_B                  , KC_MINUS              , /**/ KC_EQUAL              , KC_J                  , KC_L                  , KC_U                  , KC_Y                  , KC_SEMICOLON          , KC_BACKSLASH          ,
  KC_ESCAPE             , KC_A                  , KC_R                  , KC_S                  , KC_T                  , KC_G                  ,                         /**/                         KC_M                  , KC_N                  , KC_E                  , KC_I                  , KC_O                  , KC_QUOTE              ,
  KC_LEFT_SHIFT         , KC_Z                  , KC_X                  , KC_C                  , KC_D                  , KC_V                  , KC_LEFT_BRACKET       , /**/ KC_RIGHT_BRACKET      , KC_K                  , KC_H                  , KC_COMMA              , KC_DOT                , KC_SLASH              , KC_RIGHT_SHIFT        ,
  LCAG_T(XXXXXXX)       , KC_LEFT_CTRL          , KC_LEFT_ALT           , KC_LEFT_GUI           , KC_SPACE              ,                                                 /**/                                                 KC_BACKSPACE          , KC_RIGHT_GUI          , KC_RIGHT_ALT          , KC_RIGHT_CTRL         , LCAG_T(XXXXXXX)       ,
                                                                                                                          XXXXXXX               , RESET                 , /**/ XXXXXXX               , XXXXXXX               ,
                                                                                                                                                  XXXXXXX               , /**/ XXXXXXX               ,
                                                                                                  TD(TD_MUSIC)          , LT(ALT_CDH, XXXXXXX)  , XXXXXXX               , /**/ XXXXXXX               , LT(ALT_CDH, XXXXXXX)  , KC_ENTER
),
/* Keymap 3: Alt (Colemak DH)
 *
 * ,---------------------------------------------------.           ,--------------------------------------------------.
 * |         |  F1  |  F2  |  F3  |  F4  |  F5  |  F6  |           |  F7  |  F8  |  F9  |  F10 |  F11 |  F12 |        |
 * |---------+------+------+------+------+------+------|           |------+------+------+------+------+------+--------|
